...
<div class="demo-links">
  <a href="../demos/Synthetic-Control-Policy-Lab.html" class="btn btn-primary">View Interactive Demo</a>
  <a href="https://github.com/KhipuResearch/KASS/blob/main/notebooks/causal-inference/14-synthetic-control-policy-lab.ipynb" class="btn btn-outline">View Source</a>
</div>
